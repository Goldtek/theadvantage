...
const VantagePackage = ({price, packageName, description, toLearn, level, duration, numOfVideo, numOfLessons,  videos, Image }) => {
                        ...
                        <div className="courses-accordion">
                            <ul className="accordion">
                                ...
                                <li className="accordion-item">
                                    <a className="accordion-title" href="javascript:void(0)">
                                        <i className='bx bx-chevron-down'></i>
                                        Week 3:	Personal Leadership Program
                                    </a>
                                        ...
                                        <ul className="courses-lessons">
                                            <li className="single-lessons">
                                                <div className="d-md-flex d-lg-flex align-items-center">
                                                    ...
                                                    <a href="#" className="lessons-title">The Finder or Pioneer </a>
                                            ...
                                            <li className="single-lessons">
                                                <div className="d-md-flex d-lg-flex align-items-center">
                                                    ...
                                                    <a href="#" className="lessons-title">Defining Your Leadership</a>
                                ...
                                <li className="accordion-item">
                                    <a className="accordion-title" href="javascript:void(0)">
                                        <i className='bx bx-chevron-down'></i>
                                        Week 4:	Understand Your Success Traits
                                    </a>
                                        ...
                                        <ul className="courses-lessons">
                                            <li className="single-lessons">
                                                <div className="d-md-flex d-lg-flex align-items-center">
                                                    ...
                                                    <a href="#" className="lessons-title">	Understand Your Success Traits </a>
                                            ...
                                            <li className="single-lessons">
                                                <div className="d-md-flex d-lg-flex align-items-center">
                                                    ...
                                                    <a href="#" className="lessons-title">Aligning Your Emotional Intelligence for Success</a>
                                            ...
                                            <li className="single-lessons">
                                                <div className="d-md-flex d-lg-flex align-items-center">
                                                    ...
                                                    <a href="#" className="lessons-title">Success Temperaments’ Test</a>
                            ...
                            <li className="accordion-item">
                                    <a className="accordion-title" href="javascript:void(0)">
                                        <i className='bx bx-chevron-down'></i>
                                        Week 5:	The Art of Effective Communication 
                                    </a>
                                        ...
                                        <ul className="courses-lessons">
                                            <li className="single-lessons">
                                                <div className="d-md-flex d-lg-flex align-items-center">
                                                    ...
                                                    <a href="#" className="lessons-title">The	Learn to Speak with Power </a>
                                ...
                                <li className="accordion-item">
                                    <a className="accordion-title" href="javascript:void(0)">
                                        <i className='bx bx-chevron-down'></i>
                                        Week 6:	Crafting Vision
                                    </a>
                                </li>
                                <li className="accordion-item">
                                    <a className="accordion-title" href="javascript:void(0)">
                                        <i className='bx bx-chevron-down'></i>
                                        Week 7:	Leading Others
                                    </a>
                                </li>
                                <li className="accordion-item">
                                    <a className="accordion-title" href="javascript:void(0)">
                                        <i className='bx bx-chevron-down'></i>
                                        Week 8:	Building Reputational Capital
                                    </a>
                                </li>
                                <li className="accordion-item">
                                    <a className="accordion-title" href="javascript:void(0)">
                                        <i className='bx bx-chevron-down'></i>
                                        Week 9:	Coaching & Life Assessment Program
                                    </a>
                                </li>
                                <li className="accordion-item">
                                    <a className="accordion-title" href="javascript:void(0)">
                                        <i className='bx bx-chevron-down'></i>
                                        Week 10: Life Assessment Manual
                                    </a>
                                </li>
                ...
                <div className="col-lg-4">
                    <div className="courses-details-header">
                        <div className="courses-price">
                            ...
                            <button className="default-btn" onClick={() =>add({image:Image,price,name:packageName,id:"34ffrj4jdk",quantity:1})}><i className='bx bx-paper-plane icon-arrow before'></i><span className="label">Buy Training</span><i className="bx bx-paper-plane icon-arrow after"></i></button>
                        </div>
                    </div>
